...
```python
objetivos = {
    "curto_prazo":  ["Segurança de dados", "APIs REST com Flask", "Docker na prática"],
    "medio_prazo":  ["Ethical Hacking", "Arquitetura de microsserviços"],
    "longo_prazo":  ["Especialista em Back-End & Segurança", "Formação em 2029 🎓"]
}
```
...
|---|---|---|
| [🏙️ AcessibilidadeUrbana](https://github.com/JPBraga-Dev/AcessibilidadeUrbana) | Plataforma de acessibilidade urbana | ![JS](https://img.shields.io/badge/JS-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
| [📢 GeradorCampanhas](https://github.com/JPBraga-Dev/GeradorCampanhas) | Gerador de campanhas automatizado | ![JS](https://img.shields.io/badge/JS-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
...
💬 Bora trocar uma ideia? Me chama!
